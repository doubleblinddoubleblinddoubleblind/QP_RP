...
fopRootOriginalEmb=fopProjectRoot+'data/vectors/original-cocosoda/'
fopRootNextEmb=fopProjectRoot+'data/vectors/rq6_coco_asttrans/'

lstProjectNames=['java']
lstSizeOfReduction=[768]
currentReductionType='pca'
embeddingModel='cocosoda'
dictConfigWeightTune=dictTuneWeights['rq6_asttrans']


currentInputFeatureSize=768
fopGenerateExpectedVectors=fopProjectRoot+'vectors/'
fopSearchResults=fopProjectRoot+'results/rq6_coco_asttrans/'
