...
fopRootNextEmb=fopProjectRoot+'data/vectors/rq5_NMTOnCoCoSoDa/'
...
dictConfigWeightTune=dictTuneWeights['rq5_coco']


currentInputFeatureSize=768
fopGenerateExpectedVectors=fopProjectRoot+'vectors/'
fopSearchResults=fopProjectRoot+'results/rq5_NMTOnCoCoSoDa/'
